...
?>
<form action="procesar_datos.php?tabla=Deportes&id=<?php echo $isEditing ? $data['Identificador'] : ''; ?>" method="post">
<tr>
...
<tr>
    <td><label for="tipo_deporte">Tipo:</label></td>
    <td><input type="text" id="tipo_deporte" name="tipo_deporte" value="<?php echo $isEditing ? $data['Tipo'] : ''; ?>" required></td>
</tr>
<tr>
    <td><label for="accesorios">Accesorios:</label></td>
    <td><textarea id="accesorios" name="accesorios" required><?php echo $isEditing ? $data['Accesorio'] : ''; ?></textarea></td>
</tr>
<tr>
    <td><label for="horas_semanales">Horas Semanales:</label></td>
    <td><input type="decimal" id="horas_semanales" name="horas_semanales" value="<?php echo $isEditing ? $data['Horas_semanales'] : ''; ?>" required></td>
</tr>
<tr>
